    ...
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <div className={`${skeletonStyles.bone} ${skeletonStyles.h10} ${skeletonStyles.w28}`} />
        </div>
      </div>

      {/* Period tabs */}
      <div className={`${skeletonStyles.bone} ${skeletonStyles.h10} ${skeletonStyles.w72}`} style={{ marginBottom: '1.5rem', borderRadius: '12px' }} />
      ...
      {/* Chart row 1 */}
      <div className={styles.grid2} style={{ marginBottom: '1.375rem' }}>
        {[0, 1].map(i => (
      ...
      <div className={styles.grid2} style={{ marginBottom: '1.375rem' }}>
        {[0, 1].map(i => (
          <div key={i} className={styles.card}>
            <div className={styles.cardHeader}>
              <div className={`${skeletonStyles.bone} ${skeletonStyles.h5} ${skeletonStyles.w32}`} />
            </div>
            <div className={styles.cardBody}>
              <div className={`${skeletonStyles.bone}`} style={{ height: '120px', borderRadius: '10px' }} />
            </div>
          </div>
        ))}
      </div>
